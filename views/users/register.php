    ...
    <header id="header" class="ex-2-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Реєстрація</h1>
                    <p>Заповни форму, щоб зареєструватись на Fedo. Вже є аккаунт? Тоді ти можеш просто <a class="white" href="http://fedo/users/login">Увійти</a></p> 
                    <!-- Sign Up Form -->
                    <div class="form-container">
                        <form method="post" action="">
                            ...
                            <div class="form-group checkbox">
                                <input type="checkbox" id="sterms" value="Agreed-to-Terms" required>Я згодний/на з Fedo's <a href="privacy-policy.html">Політика конфеденційності</a> й <a href="terms-conditions.html">Умови</a>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
